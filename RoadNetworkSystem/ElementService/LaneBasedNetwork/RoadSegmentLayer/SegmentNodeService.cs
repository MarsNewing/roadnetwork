...
{
    class SegmentNodeService:NodeMasterService
    {
        ...
        public SegmentNodeService(IFeatureClass pFeaClsRSNode,int rsNodeID,IPoint pnt):base(pFeaClsRSNode,rsNodeID,pnt)
        {
            try
            {
