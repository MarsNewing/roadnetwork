...
namespace RoadNetworkSystem.NetworkElement.LaneBasedNetwork.Connection
{
    class PhysicalConnection
    {
        ...
        public static void GetAntiClockLinkInfor(int curLinkID, NodeEntity nextNodeEty, ref int antiClockLink,ref double antiClockAngle)
        {
        ...
        public static void GetClockLinkInfor(int curLinkID, NodeEntity preNodeEty, ref int clockLink, ref double clockAngle)
        {
        ...
        /// <returns></returns>
        private static int getLinkIndex(int linkID, NodeEntity nodeEty)
        {
        ...
        public static double GetLinksAngle(int fromLinkID, int toLinkID, NodeEntity nodeEty)
        {
            double angle = 0;
