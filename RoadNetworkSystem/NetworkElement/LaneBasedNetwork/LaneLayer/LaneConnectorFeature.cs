...
namespace RoadNetworkSystem.NetworkElement.LaneBasedNetwork.LaneLayer
{
    class LaneConnectorFeature
    {
        ...
        public LaneConnectorFeature(IFeatureClass pFeaClsConnector, int connectorID)
        {
        ...
        public LaneConnectorEntity GetLaneConnEty(IFeature targetFea)
        {
        ...
        public void InsertLConnector(LaneConnectorEntity updateLaneConnEty,IPolyline connLine)
        {
        ...
        public void CreateConnectorInNode(NodeEntity nodeEty, IFeatureClass pFeaClsLink, IFeatureClass pFeaClsArc)
        {
        ...
        public void CreateConnectorInArcs(IFeatureClass pFeaClsLane,ArcEntity fromArcEty, 
            ArcEntity toArcEty, string TurningDir,IPoint nodePnt)
        {
                    ...
                    case "Right":
                        {
                            ...
                            if (fromArcLaneNum >= 5)
                            {
                                if (toArcLaneNum < 2)
                                {
                                    ...
                                    fromLaneID = Convert.ToInt32(fromLaneFea.get_Value(pFeaClsLane.FindField(LaneFeature.LaneIDNm)));
                                    fromLine = fromLaneFea.ShapeCopy as IPolyline;

                                    toLaneFea = lane.QueryFeatureBuRule(toArcID, toLanePosition);
                                    toLaneID = Convert.ToInt32(toLaneFea.get_Value(pFeaClsLane.FindField(LaneFeature.LaneIDNm)));
                                    toLine = toLaneFea.ShapeCopy as IPolyline;
                                    bezierLine = GetConnectorShape(fromLine, toLine, null, false);

                                    LaneConnectorEntity connectorEntity1 = InitConnectorEty(0, fromLinkID, toLinkID, fromArcID, toArcID,
                                ...
                                else
                                {
                                    ...
                                    LaneConnectorEntity connectorEntity2 = InitConnectorEty(0, fromLinkID, toLinkID, fromArcID, toArcID,
                                        fromArcDir, toArcDir, fromLaneID, toLaneID, TurningDir);
                    ...
                    case "Left":
                        {
                            ...
                            if (fromArcLaneNum >= 5)
                            {
                                if (toArcLaneNum >= 2)
                                {
                                    ...
                                    LaneConnectorEntity connectorEntity = InitConnectorEty(0, fromLinkID, toLinkID, fromArcID, toArcID,
                                        fromArcDir, toArcDir, fromLaneID, toLaneID, TurningDir);
