...
namespace RoadNetworkSystem.NetworkElement.LaneBasedNetwork.LaneLayer
{
    class LaneConnectorTable
    {
        ...
        public LaneConnectorTable(ITable tableConnector,int connectorID)
        {
        ...
        public LaneConnectorEntity GetLaneConnEty(int connectorID)
        {
            LaneConnectorEntity targetLaneEty = new LaneConnectorEntity();
        ...
        public void InsertLConnector(LaneConnectorEntity updateLaneConnEty)
        {
        ...
        public void UpdateConnector(LaneConnectorEntity updateLaneConnEty, int preLaneConnID)
        {
            LaneConnectorEntity preLaneConnEty = GetLaneConnEty(preLaneConnID);
        ...
        public void CreateConnectorByDefault(Link fromLink, Link toLink, int intersctionNode)
        {
            ...
            IFeatureClass pFeaClsArc=(pWS as IFeatureWorkspace).OpenFeatureClass(ArcEntity.ArcFeatureName);
            Arc arc = new Arc(pFeaClsArc, -1);

            ArcEntity fromArcEity = new ArcEntity();
            ...
            ArcEntity toArcEity = new ArcEntity();
                ...
                case "Right":
                    {
                        ...
                        {
                            LaneConnectorEntity connectorEntity1 = InitConnectorEty(_connectorID, fromLinkID, toLinkID, fromArcID, fromArcID, fromArcDir, toArcDir, fromArcID * 10 + fromArcLaneNum - 1, toArcID * 10 + toArcLaneNum, TurningDir);
                            InsertLConnector(connectorEntity1);
                            _connectorID = _connectorID + 1;
                            if (toArcLaneNum > 2)
                            {
                                LaneConnectorEntity connectorEntity2 = InitConnectorEty(_connectorID, fromLinkID, toLinkID, fromArcID, fromArcID, fromArcDir, toArcDir, fromArcID * 10 + fromArcLaneNum, toArcID * 10 + toArcLaneNum, TurningDir);
                        ...
                        {
                            LaneConnectorEntity connectorEntity1 = InitConnectorEty(_connectorID, fromLinkID, toLinkID, fromArcID, fromArcID, fromArcDir, toArcDir, fromArcID * 10 + fromArcLaneNum, toArcID * 10 + toArcLaneNum, TurningDir);
                            InsertLConnector(connectorEntity1);
                            _connectorID = _connectorID + 1;
                        }
                        else if (fromArcLaneNum >= 5 && toArcLaneNum >= 5)
                        {
                            LaneConnectorEntity connectorEntity1 = InitConnectorEty(_connectorID, fromLinkID, toLinkID, fromArcID, fromArcID, fromArcDir, toArcDir, fromArcID * 10 + fromArcLaneNum - 1, toArcID * 10 + toArcLaneNum - 1, TurningDir);
                            InsertLConnector(connectorEntity1);
                            _connectorID = _connectorID + 1;
                            LaneConnectorEntity connectorEntity2 = InitConnectorEty(_connectorID, fromLinkID, toLinkID, fromArcID, fromArcID, fromArcDir, toArcDir, fromArcID * 10 + fromArcLaneNum, toArcID * 10 + toArcLaneNum, TurningDir);
                            InsertLConnector(connectorEntity2);
                        ...
                        {
                            LaneConnectorEntity connectorEntity1 = InitConnectorEty(_connectorID, fromLinkID, toLinkID, fromArcID, fromArcID, fromArcDir, toArcDir, fromArcID * 10 + fromArcLaneNum, toArcID * 10 + toArcLaneNum - 1, TurningDir);
                            InsertLConnector(connectorEntity1);
                            _connectorID = _connectorID + 1;
                            if (fromArcLaneNum > 2)
                            {
                ...
                case "Left":
                    {
                        if (fromArcLaneNum >= 5 && toArcLaneNum < 5)
                        {
                            LaneConnectorEntity connectorEntity1 = InitConnectorEty(_connectorID, fromLinkID, toLinkID, fromArcID, fromArcID, fromArcDir, toArcDir, fromArcID * 10 + 1, toArcID * 10 + 1, TurningDir);
                            InsertLConnector(connectorEntity1);
                            _connectorID = _connectorID + 1;
                            if (toArcLaneNum > 2)
                            {
                                LaneConnectorEntity connectorEntity2 = InitConnectorEty(_connectorID, fromLinkID, toLinkID, fromArcID, fromArcID, fromArcDir, toArcDir, fromArcID * 10 + 2, toArcID * 10 + 1, TurningDir);
                                InsertLConnector(connectorEntity2);
                                _connectorID = _connectorID + 1;
                            }
                        ...
                        else if (fromArcLaneNum >= 5 && toArcLaneNum >= 5)
                        {
                            ...
                            LaneConnectorEntity connectorEntity2 = InitConnectorEty(_connectorID, fromLinkID, toLinkID, fromArcID, fromArcID, fromArcDir, toArcDir, fromArcID * 10 + 2, toArcID * 10 + 2, TurningDir);
                            InsertLConnector(connectorEntity2);
                            _connectorID = _connectorID + 1;
                        }
                        else
                        {
                            ...
                            LaneConnectorEntity connectorEntity2 = InitConnectorEty(_connectorID, fromLinkID, toLinkID, fromArcID, fromArcID, fromArcDir, toArcDir, fromArcID * 10 + 1, toArcID * 10 + 2, TurningDir);
                            InsertLConnector(connectorEntity2);
                            _connectorID = _connectorID + 1;
                        }
                    } break;
                ...
                case "Straight":
                    {
                        if (fromArcLaneNum > 2 && fromArcLaneNum == toArcLaneNum)
                        {
                            ...
                            {
                                LaneConnectorEntity connectorEntity1 = InitConnectorEty(_connectorID, fromLinkID, toLinkID, fromArcID, fromArcID, fromArcDir, toArcDir, fromArcID * 10 + i, toArcID * 10 + i, TurningDir);
                                InsertLConnector(connectorEntity1);
                                _connectorID = _connectorID + 1;
                            }
                        ...
                        if (toArcLaneNum > 2 && fromArcLaneNum > toArcLaneNum)
                        {
                            ...
                            for (int i = 2; i < fromArcLaneNum; i++)
                            {
                                if (i <= (int)toArcLaneNum / 2)
                                {
                                    ...
                                    InsertLConnector(connectorEntity1);
                                    _connectorID = _connectorID + 1;
                                    LaneConnectorEntity connectorEntity2 = InitConnectorEty(_connectorID, fromLinkID, toLinkID, fromArcID, fromArcID, fromArcDir, toArcDir, fromArcID * 10 + fromArcLaneNum - i + 1, toArcID * 10 + toArcLaneNum - i + 1, TurningDir);
                                    InsertLConnector(connectorEntity2);
                                    _connectorID = _connectorID + 1;
                                }
                                else if (i > (int)toArcLaneNum / 2 && i < fromArcLaneNum - (int)toArcLaneNum / 2)
                                {
                                    ...
                                    LaneConnectorEntity connectorEntity1 = InitConnectorEty(_connectorID, fromLinkID, toLinkID, fromArcID, fromArcID, fromArcDir, toArcDir, fromArcID * 10 + i, toLaneID, TurningDir);
                                    _connectorID = _connectorID + 1;
                                }
                            }
                        }
                        if (fromArcLaneNum > 2 && fromArcLaneNum < toArcLaneNum)
                        {
                            ...
                            for (int i = 2; i < toArcLaneNum; i++)
                            {
                                ...
                                else if (i > (int)fromArcLaneNum / 2 && i < fromArcLaneNum - (int)fromArcLaneNum / 2)
                                {
                                    ...
                                    LaneConnectorEntity connectorEntity1 = InitConnectorEty(_connectorID, fromLinkID, toLinkID, fromArcID, fromArcID, fromArcDir, toArcDir, fromLaneID, toArcID * 10 + i, TurningDir);
                                    InsertLConnector(connectorEntity1);
                                    _connectorID = _connectorID + 1;
                                }
                            }
                        ...
                        if (fromArcLaneNum <= 2)
                        {
                            ...
                            for (int i = 1; i < toArcLaneNum; i++)
                            {
                                ...
                                {
                                    LaneConnectorEntity connectorEntity1 = InitConnectorEty(_connectorID, fromLinkID, toLinkID, fromArcID, fromArcID, fromArcDir, toArcDir, fromArcID * 10 + 1, toArcID * 10 + i, TurningDir);
                                    InsertLConnector(connectorEntity1);
                                    _connectorID = _connectorID + 1;
                                }
                            }
                        ...
                        if (toArcLaneNum <= 2)
                        {
                            for (int i = 1; i < fromArcLaneNum; i++)
                            {
                                ...
                                if (eixtConnectorFlag == false)
                                {
                                    LaneConnectorEntity connectorEntity1 = InitConnectorEty(_connectorID, fromLinkID, toLinkID, fromArcID, fromArcID, fromArcDir, toArcDir, fromArcID * 10 + i, toArcID * 10 + 1, TurningDir);
                                    InsertLConnector(connectorEntity1);
                                    _connectorID = _connectorID + 1;
                                }
        ...
        public LaneConnectorEntity InitConnectorEty(int connectorID, int fromLinkID, int toLinkID, int fromArcID, int toArcID, int fromArcDir, int toArcDir, int fromLaneID, int toLaneID, string TurningDir)
        {
            LaneConnectorEntity connectorEntity = new LaneConnectorEntity();
