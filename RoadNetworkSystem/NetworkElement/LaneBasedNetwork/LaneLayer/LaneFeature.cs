...
namespace RoadNetworkSystem.NetworkElement.LaneBasedNetwork.LaneLayer
{
    class LaneFeature
    {
        ...
        public LaneFeature(IFeatureClass pFeaClsLane, int laneID)
        {
        ...
        public LaneEntity GetEntity(IFeature pFeature)
        {
        ...
        public IFeature CreateLane(LaneEntity updateLaneEty,IPolyline line)
        {
        ...
        public void UpdateLane(LaneEntity updateLaneConnEty, int prelaneID)
        {
            ...
            if (laneFea != null)
            {
                LaneEntity preLaneEty = GetEntity(laneFea);
