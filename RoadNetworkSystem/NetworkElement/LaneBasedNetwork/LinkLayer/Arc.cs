...
namespace RoadNetworkSystem.NetworkElement.LaneBasedNetwork.LinkLayer
{
    class Arc
    {
        ...
        public Arc(IFeatureClass pFeaClsArc,int arcID)
        {
        ...
        public IFeature CreateArc(ArcEntity arcEty, IPolyline line)
        {
        ...
        /// <param name="arcID"></param>
        /// <returns></returns>
        public ArcEntity GetArcEty(IFeature arcFea)
        {
        ...
        public ArcEntity GetArcEtyByRule(string QueryStr)
        {
        ...
        public double GetArcWidth(IFeatureClass pFeaClsLane)
        {
            ...
            while (pFeatureLane != null)
            {
                try
                {
                    int lFld = pFeaClsLane.FindField(LaneFeature.WidthNm);
