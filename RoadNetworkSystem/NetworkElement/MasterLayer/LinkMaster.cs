...
namespace RoadNetworkSystem.NetworkElement.MasterLayer
{
    class LinkMaster
    {
        ...
        public LinkMaster(IFeatureClass pFeaClsSegment,int id)
        {
        ...
        public IFeature Create(LinkMasterEntity segEty, IPolyline line)
        {
        ...
        public LinkMasterEntity GetEntity(IFeature feaLink)
        {
            LinkMasterEntity segEty = new LinkMasterEntity();
            try
            {
