...
namespace RoadNetworkSystem.NetworkElement.MasterLayer
{
    class NodeMaster
    {
        ...
        public NodeMaster(IFeatureClass pFeaClsSegment, int nodeID, IPoint pnt)
        {
        ...
        /// <returns></returns>
        public NodeMasterEntity GetNodeMasterEty(IFeature nodeFea)
        {
            NodeMasterEntity nodeMaster = new NodeMasterEntity();
            try
            {
        ...
        public IFeature CreateNode(NodeMasterEntity nodeMasterEty)
        {
        ...
        public void CreateAdjData(LinkMaster seg)
        {
        ...
        private List<DataInfo> GetAdjInfo(LinkMaster seg)
        {
